...
import sty from "./PlasmicButton.module.css"; // plasmic-import: T868m2MaLz1c/css
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__s2GK)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Icon2Icon
              className={classNames(projectcss.all, sty.svg__gZkiB)}
              role={"img"}
            />
          ),
